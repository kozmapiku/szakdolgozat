...
@Component({
  ...
  templateUrl: './modify-accommodation.component.html',
  styleUrls: ['./modify-accommodation.component.css']
})
export class ModifyAccommodationComponent implements OnInit {
